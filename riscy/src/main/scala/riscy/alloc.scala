...
//
//  expect(c.io.allocROB(3).valid, )
//  expect(c.io.allocROB(3).bits.op, )
//  expect(c.io.allocROB(3).bits.funct3, )
//  expect(c.io.allocROB(3).bits.funct7, )
